    ...
    return (
      <div className='container'>
        ...
        <div>
          ...
          <p>Model: {modelDetials.Model}</p>
          <p>Ex Showroom Price: {modelDetials['Ex Showroom Price']} Rs</p>
          <p>Battery Size: {modelDetials['Battery Size']}</p>
          <p>Battery Type: {modelDetials['Battery Type']}</p>
          <p>Charger Rating: {modelDetials['Charger Rating']}</p>
          <p>Driving Range: {modelDetials['Driving Range']} KM</p>
          <p>Charging Time: {modelDetials['Charging Time']} Hrs</p>
        </div>
      )}
      </div>
    );
